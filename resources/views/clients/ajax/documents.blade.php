                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <x-forms.file :fieldLabel="__('modules.projects.uploadFile')" fieldName="file"
                            fieldRequired="true" fieldId="client_file" allowedFileExtensions="txt pdf doc xls xlsx docx rtf png jpg jpeg svg zip" :popover="__('messages.fileFormat.multipleImageFile')" />
                    </div>
                    <div class="col-md-12">

...
<aside class="{{ !user()->dark_theme ? 'sidebar-' . $appTheme->sidebar_theme : '' }}">
    ...
    <div
        ...
        @endif
        <p class="mb-0 text-dark-grey px-1 py-0 rounded f-10">v{{ \Illuminate\Support\Facades\File::exists(base_path('version.txt')) ? trim(\Illuminate\Support\Facades\File::get(base_path('version.txt'))) : '5.5.20' }}</p>
    </div>
    <!-- Sidebar Toggler -->

                ...
                <div class="row">
                    <div class="col-lg-6">
                        <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2"
                                      ...
                                      fieldRequired="false"
                                      fieldName="address"
                                      fieldId="address" :fieldValue="company()->address"/>
                    </div>
                    <div class="col-lg-6">
                        <x-forms.number class="mr-0 mr-lg-2 mr-md-2"
                                      :fieldLabel="__('modules.accountSettings.defaultNoticePeriod')"
                                      fieldPlaceholder="e.g. 2"
                                      fieldRequired="false"
                                      fieldName="default_notice_period_months"
                                      fieldId="default_notice_period_months"
                                      :fieldValue="company()->default_notice_period_months"/>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg"
                                      ...
                                      :fieldLabel="__('modules.accountSettings.authorizedSignature')"
                                      :fieldValue="company()->signature_url"
                                      fieldName="signature_image"
                                      fieldId="signature_image"

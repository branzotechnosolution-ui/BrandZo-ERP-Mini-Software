...
return array(
    ...
    'employees' => array(
        'noticePeriodStartedSubject' => 'Notice Period Started - :employee',
        'noticePeriodStartedLine' => ':employee\'s notice period has started on :start and is expected to end on :end.',
        ...
        'takeHome' => 'Take Home (Calculated Monthly)',
    ...
    'accountSettings' => array(
        ...
        'defaultNoticePeriod' => 'Default Notice Period (Months)',
        'authorizedSignature' => 'Authorized Signature (for Offer Letters)',
    ...
    'update' => array(
        ...
        'fileReplaceAlert' => 'To update BranZo Techno Solution to the new version check documentation for the instructions.',

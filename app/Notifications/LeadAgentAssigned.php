...
class LeadAgentAssigned extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $clientEmailVal = $this->deal->client_email ?: ($this->deal->contact?->client_email ?: '--');
        $leadEmail = __('modules.lead.clientEmail') . ': ';
        $content = __('email.leadAgent.subject') . '<br>' . __('modules.deal.dealName') . ': '  . $this->deal->name . '<br>' .  __('modules.lead.clientName') . ': '  . $clientName . '<br>' . $leadEmail . $clientEmailVal;

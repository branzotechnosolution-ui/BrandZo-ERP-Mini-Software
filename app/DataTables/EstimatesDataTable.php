...
class EstimatesDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $datatables->addColumn('estimate_number', function ($row) {
            ...
            $estCode = 'BZEST' . str_pad($cNum, 3, '0', STR_PAD_LEFT) . '-' . str_pad($row->id, 3, '0', STR_PAD_LEFT);
            return '<a href="' . route('estimates.show', $row->id) . '" class="text-darkest-grey font-weight-bold">' . $estCode . '</a>';
        });

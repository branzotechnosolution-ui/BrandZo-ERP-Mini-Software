...
class ProjectsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $datatables->editColumn('project_short_code', function ($row) {
            ...
            $code = 'BZP' . str_pad($cNum, 3, '0', STR_PAD_LEFT) . '-' . str_pad($row->id, 3, '0', STR_PAD_LEFT);
            return '<a href="' . route('projects.show', [$row->id]) . '" class="text-darkest-grey font-weight-bold">' . $code . '</a>';
        });

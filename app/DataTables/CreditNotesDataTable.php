    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->editColumn('cn_number', function ($row) {
                ...
                $cnCode = 'BZCN' . str_pad($cNum, 3, '0', STR_PAD_LEFT) . '-' . str_pad($row->id, 3, '0', STR_PAD_LEFT);
                return '<a href="' . route('creditnotes.show', $row->id) . '" class="text-darkest-grey font-weight-bold">' . $cnCode . '</a>';
            })

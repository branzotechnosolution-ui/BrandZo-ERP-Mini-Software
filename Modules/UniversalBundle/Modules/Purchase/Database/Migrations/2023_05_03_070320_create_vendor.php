...
Schema::table('products', function (Blueprint $table) use ('products') {
            ...
            $table->unsignedBigInteger('opening_stock')->after('purchase_description')->nullable(); }
        ...
        if (!Schema::hasTable('purchase_vendor_contacts')) {
            Schema::create('purchase_vendor_contacts', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('purchase_vendor_id')->index('purchase_vendor_contacts_purchase_vendor_id_foreign'); }
        ...
        if (!Schema::hasTable('purchase_vendor_notes')) {
            Schema::create('purchase_vendor_notes', function (Blueprint $table) {
                $table->increments('id'); }
                $table->unsignedBigInteger('company_id')->nullable(); }
                $table->unsignedBigInteger('purchase_vendor_id')->unsigned(); }
                $table->foreign('purchase_vendor_id')->references('id')->on('purchase_vendors')->onDelete('cascade')->onUpdate('cascade'); }
        ...
        if (!Schema::hasTable('purchase_order_settings')) {
            Schema::create('purchase_order_settings', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('purchase_number_digit')->nullable()->default(3); }
                $table->timestamps(); }
            }); }
        }
        ...
        if (!Schema::hasTable('purchase_orders')) {
            Schema::create('purchase_orders', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('bank_account_id')->unsigned()->nullable(); }
                ...
                $table->unsignedBigInteger('default_currency_id')->unsigned()->nullable(); }
                ...
                $table->unsignedBigInteger('added_by')->nullable()->index('purchase_orders_added_by_foreign'); }
                $table->unsignedBigInteger('last_updated_by')->nullable()->index('purchase_orders_last_updated_by_foreign'); }
        ...
        if (!Schema::hasTable('purchase_item_taxes')) {
            Schema::create('purchase_item_taxes', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('purchase_order_id')->unsigned()->nullable(); }
                $table->foreign('purchase_order_id')->references('id')->on('purchase_orders')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('purchase_item_id')->unsigned()->nullable(); }
        ...
        if (!Schema::hasTable('purchase_bills')) {
            Schema::create('purchase_bills', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('company_id')->unsigned()->nullable(); }
                $table->foreign('company_id')->references('id')->on('companies')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('purchase_bill_number'); }
                $table->unsignedBigInteger('purchase_vendor_id')->unsigned(); }
                $table->foreign('purchase_vendor_id')->references('id')->on('purchase_vendors')->onDelete('cascade')->onUpdate('cascade'); }
        ...
        if (!Schema::hasTable('purchase_inventory_files')) {
            Schema::create('purchase_inventory_files', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('added_by')->nullable()->index('project_files_added_by_foreign'); }
                $table->unsignedBigInteger('last_updated_by')->nullable()->index('project_files_last_updated_by_foreign'); }
                $table->foreign(['added_by'])->references(['id'])->on('users')->onUpdate('CASCADE')->onDelete('SET NULL'); }
                $table->foreign(['last_updated_by'])->references(['id'])->on('users')->onUpdate('CASCADE')->onDelete('SET NULL'); }
                $table->timestamps(); }
            }); }
        ...
        if (!Schema::hasTable('purchase_stock_adjustments')) {
            Schema::create('purchase_stock_adjustments', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('quantity_adjustment')->default(0)->nullable(); }
                $table->text('description')->nullable(); }
        ...
        if (!Schema::hasTable('purchase_vendor_payments')) {
            Schema::create('purchase_vendor_payments', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('vendor_credit_id')->nullable()->index('purchase_vendor_credits_id_foreign'); }
                $table->unsignedBigInteger('bank_account_id')->unsigned()->nullable(); }
                $table->foreign('bank_account_id')->references('id')->on('bank_accounts')->onDelete('cascade')->onUpdate('cascade'); }
        ...
        if (!Schema::hasTable('purchase_item_images')) {
            Schema::create('purchase_item_images', function (Blueprint $table) {
                $table->increments('id'); }
                $table->unsignedBigInteger('purchase_item_id')->index('purchase_item_images_purchase_item_id_foreign'); }
        ...
        if (!Schema::hasTable('purchase_order_files')) {
            Schema::create('purchase_order_files', function (Blueprint $table) {
                $table->increments('id'); }
                $table->unsignedBigInteger('purchase_order_id')->index('purchase_files_invoice_id_foreign'); }
                $table->foreign(['purchase_order_id'])->references(['id'])->on('purchase_orders')->onUpdate('CASCADE')->onDelete('CASCADE'); }
                $table->unsignedBigInteger('added_by')->nullable()->index('purchase_files_added_by_foreign'); }
                $table->foreign(['added_by'])->references(['id'])->on('users')->onUpdate('CASCADE')->onDelete('SET NULL'); }
                $table->unsignedBigInteger('last_updated_by')->nullable()->index('purchase_files_last_updated_by_foreign'); }
                $table->foreign(['last_updated_by'])->references(['id'])->on('users')->onUpdate('CASCADE')->onDelete('SET NULL'); }
        ...
        if (!Schema::hasTable('purchase_vendor_histories')) {
            Schema::create('purchase_vendor_histories', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('company_id')->unsigned()->nullable(); }
                $table->foreign('company_id')->references('id')->on('companies')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('purchase_vendor_id')->unsigned()->nullable(); }
                $table->foreign('purchase_vendor_id')->references('id')->on('purchase_vendors')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('purchase_vendor_notes_id')->unsigned()->nullable(); }
                $table->foreign('purchase_vendor_notes_id')->references('id')->on('purchase_vendor_notes')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('purchase_vendor_contact_id')->unsigned()->nullable(); }
        ...
        if (!Schema::hasTable('purchase_vendor_user_notes')) {
            Schema::create('purchase_vendor_user_notes', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('company_id')->unsigned()->nullable(); }
                $table->foreign('company_id')->references('id')->on('companies')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('user_id')->index('purchase_vendor_user_notes_user_id_foreign'); }
                $table->unsignedBigInteger('vendor_note_id')->index('purchase_vendor_user_notes_vendor_note_id_foreign'); }
        ...
        if (!Schema::hasTable('purchase_product_histories')) {
            Schema::create('purchase_product_histories', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('company_id')->unsigned()->nullable(); }
                $table->foreign('company_id')->references('id')->on('companies')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('purchase_product_id')->unsigned()->nullable(); }
        ...
        if (!Schema::hasTable('purchase_vendor_credits')) {
            Schema::create('purchase_vendor_credits', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('added_by')->nullable()->index('purchase_vendor_credits_added_by_foreign'); }
                $table->unsignedBigInteger('last_updated_by')->nullable()->index('purchase_vendor_credits_last_updated_by_foreign'); }
                $table->foreign(['added_by'])->references(['id'])->on('users')->onUpdate('CASCADE')->onDelete('SET NULL'); }
                $table->foreign(['last_updated_by'])->references(['id'])->on('users')->onUpdate('CASCADE')->onDelete('SET NULL'); }
                $table->timestamps(); }
            }); }
        ...
        if (!Schema::hasTable('purchase_vendor_items')) {
            Schema::create('purchase_vendor_items', function (Blueprint $table) {
                $table->increments('id'); }
                $table->unsignedBigInteger('credit_id')->unsigned()->nullable(); }
        ...
        if (!Schema::hasTable('purchase_vendor_credit_item_images')) {
            Schema::create('purchase_vendor_credit_item_images', function (Blueprint $table) {
                $table->increments('id'); }
                $table->unsignedBigInteger('vendor_item_id')->index('purchase_vendor_item_images_vendor_item_id_foreign'); }
            ...
            Schema::create('purchase_payment_histories', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('purchase_vendor_id')->unsigned()->nullable(); }
                $table->foreign('purchase_vendor_id')->references('id')->on('purchase_vendors')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('purchase_payment_id')->unsigned()->nullable(); }
        ...
        if (!Schema::hasTable('purchase_vendor_credit_histories')) {
            Schema::create('purchase_vendor_credit_histories', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('company_id')->unsigned()->nullable(); }
                $table->foreign('company_id')->references('id')->on('companies')->onDelete('cascade')->onUpdate('cascade'); }
                $table->unsignedBigInteger('purchase_credit_id')->unsigned()->nullable(); }
        ...
        if (!Schema::hasTable('purchase_inventory_histories')) {
            Schema::create('purchase_inventory_histories', function (Blueprint $table) {
                ...
                $table->double('changed_value', 16, 2)->default(0)->nullable(); }
                $table->double('adjusted_value', 16, 2)->default(0)->nullable(); }
                $table->unsignedBigInteger('purchase_inventory_files_id')->unsigned()->nullable(); }

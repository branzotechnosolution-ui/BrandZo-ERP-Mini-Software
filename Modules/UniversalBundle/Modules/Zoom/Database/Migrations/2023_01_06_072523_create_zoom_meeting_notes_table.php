    ...
    public function up()
    {
        Schema::create(
            'zoom_meeting_notes', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('added_by')->nullable()->index('zoom_meeting_added_by_foreign');
                $table->foreign(['added_by'])->references(['id'])->on('users')->onUpdate('CASCADE')->onDelete('SET NULL');

                $table->unsignedBigInteger('last_updated_by')->nullable()->index('zoom_meeting_last_updated_by_foreign');

    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('objectives')) {
            Schema::create('objectives', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('department_id')->nullable()->index('objectives_department_id_foreign');
                ...
                $table->unsignedBigInteger('rotation_date')->nullable();
                $table->boolean('send_check_in_reminder')->default(true);
                $table->unsignedBigInteger('created_by')->nullable()->index('objectives_users_id_foreign');
        ...
        if (!Schema::hasTable('key_results')) {
            Schema::create('key_results', function (Blueprint $table) {
                ...
                $table->string('title');
                $table->text('description')->nullable();
                $table->unsignedBigInteger('metrics_id')->nullable()->index('key_results_metrics_id_foreign');
        ...
        if (!Schema::hasTable('check_ins')) {
            Schema::create('check_ins', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('check_in_by')->nullable()->index('check_ins_users_id_foreign');

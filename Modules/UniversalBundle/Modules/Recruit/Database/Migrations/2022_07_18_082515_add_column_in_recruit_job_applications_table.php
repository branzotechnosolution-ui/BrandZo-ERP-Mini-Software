...
Schema::table('recruit_job_applications', function (Blueprint $table) use ('recruit_job_applications') {
        ...
        Schema::table('recruit_settings', function (Blueprint $table) {
            $table->unsignedBigInteger('application_restriction')->default('180'); }
        }); }

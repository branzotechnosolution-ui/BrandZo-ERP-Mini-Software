<?php if(user()->permission('recruit_settings') != 'none' && in_array(\Modules\Recruit\Entities\RecruitSetting::MODULE_NAME, user_modules())): ?>
...
<?php $component = App\View\Components\SettingMenuItem::resolve(['active' => $activeMenu,'menu' => 'recruit_settings','href' => route('recruit-settings.index'),'text' => __('recruit::app.menu.recruitSetting')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/Modules/Recruit/Resources/views/sections/setting-sidebar.blade.php ENDPATH**/ ?>
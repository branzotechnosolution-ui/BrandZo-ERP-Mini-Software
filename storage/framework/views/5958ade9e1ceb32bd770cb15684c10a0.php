<?php if(in_array('leave', $activeWidgets) && $sidebarUserPermissions['view_leave'] != 5 && $sidebarUserPermissions['view_leave'] != 'none' && in_array('employees', user_modules())): ?>
...
<?php endif; ?>
                        ...
                        <td class="pr-20">
                            ...
                            <?php elseif($totalLeave->duration == 'half day' && $totalLeave->half_day_type == 'first_half'): ?>
                        ...
                        <td class="pr-20" align="right">
                            <span class="badge badge-success p-2"
                                  style="background-color:<?php echo e($totalLeave->type->color); ?>"><?php echo e($totalLeave->type->type_name); ?></span>
                        </td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/dashboard/employee/widgets/leave.blade.php ENDPATH**/ ?>
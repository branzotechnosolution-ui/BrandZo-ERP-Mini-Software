...
<aside class="<?php echo e(!user()->dark_theme ? 'sidebar-' . $appTheme->sidebar_theme : ''); ?>">
    ...
    <div
        ...
        <?php endif; ?>
        <p class="mb-0 text-dark-grey px-1 py-0 rounded f-10">v<?php echo e(\Illuminate\Support\Facades\File::exists(base_path('version.txt')) ? trim(\Illuminate\Support\Facades\File::get(base_path('version.txt'))) : '5.5.20'); ?></p>
    </div>
    <!-- Sidebar Toggler -->

    <?php echo $__env->make('sections.raise-support-ticket-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</aside>
<!-- SIDEBAR END -->
...
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/sections/sidebar.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
    ...
    <input type="text" class="form-control height-35 f-14" placeholder="<?php echo e($fieldPlaceholder); ?>"
           ...
           <?php if($fieldReadOnly == 'true'): echo 'readonly'; endif; ?>>

    <?php if($fieldHelp): ?>
        <small id="<?php echo e($fieldId); ?>Help" class="form-text text-muted"><?php echo e($fieldHelp); ?></small>
    <?php endif; ?>
</div>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/components/forms/text.blade.php ENDPATH**/ ?>
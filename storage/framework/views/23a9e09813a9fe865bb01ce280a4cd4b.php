...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-redirect-url' => ''.e(route('holidays.index')).'','class' => 'mr-3 openRightModal float-left']); ?>
...
<?php endif; ?>
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group" aria-label="Basic example">
                ...
                <a href="<?php echo e(route('holidays.table_view')); ?>" class="btn btn-secondary f-14" data-toggle="tooltip"
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var addEvent = function(date) {
            openTaskDetail();
            let url = `<?php echo e(route('holidays.create')); ?>?date=${date}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/holiday/calendar/index.blade.php ENDPATH**/ ?>
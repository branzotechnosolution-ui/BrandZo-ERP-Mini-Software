...
<?php if((!in_array('client', user_roles())) && $viewPurchaseSettingPermission == 'all' && in_array(\Modules\Purchase\Entities\PurchaseSetting::MODULE_NAME, user_modules())): ?>
...
<?php $component = App\View\Components\SettingMenuItem::resolve(['active' => $activeMenu,'menu' => 'purchase_settings','href' => route('purchase-settings.index'),'text' => __('purchase::app.menu.purchaseSettings')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/Modules/Purchase/Providers/../Resources/views/sections/setting-sidebar.blade.php ENDPATH**/ ?>
...
<?php foreach($attributes->onlyProps(['showActions' => false]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['showActions' => false]); ?>
<?php foreach (array_filter((['showActions' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<div class="card border-0 b-shadow-4 rounded-lg mb-4 bg-white" id="hrms-attendance-widget">
    ...
    <div class="card-header bg-white border-bottom-grey font-weight-bold f-16 py-3 px-4 d-flex flex-column flex-md-row justify-content-between align-items-md-center">
        <div class="d-flex align-items-center mb-2 mb-md-0">
            ...
            <div>
                <h4 class="f-16 font-weight-bold text-darkest-grey mb-0"><?php echo e($user->name); ?></h4>
                <p class="f-12 text-dark-grey mb-0 mt-1">
                    <i class="fa fa-calendar-alt text-primary mr-1"></i><?php echo e($todayDate); ?>
                ...
                <?php if(!empty($timelineEvents)): ?>
                    <?php $__currentLoopData = $timelineEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex align-items-center bg-light p-2 px-3 rounded-lg border border-grey mr-3 mb-2">
                            <span class="f-12 font-weight-bold text-darkest-grey mr-2"><?php echo e($event['time']); ?></span>
                            <span class="badge <?php echo e($event['badge']); ?> px-2 py-1 font-weight-semibold f-11 rounded">
                                <i class="fa <?php echo e($event['icon']); ?> mr-1 text-white"></i><?php echo e($event['label']); ?>
        ...
        <div class="modal-content border-0 b-shadow-4 rounded-lg">
            ...
            <div class="modal-body p-4">
                <div class="text-center mb-4">
                    ...
                    <h4 class="f-16 font-weight-bold text-darkest-grey mb-1"><?php echo e($user->name); ?></h4>
                    <p class="f-12 text-lightest mb-0"><?php echo e($todayDate); ?></p>
                </div>
                ...
                <div class="list-group list-group-flush rounded-lg border border-grey mb-3">
                    <div class="list-group-item d-flex justify-content-between align-items-center f-14 py-3">
                        ...
                        <span class="font-weight-bold text-darkest-grey"><?php echo e($loginTime); ?></span>
                    </div>
                    <div class="list-group-item d-flex justify-content-between align-items-center f-14 py-3">
                        <span class="text-dark-grey"><i class="fa fa-sign-in-alt text-success mr-2"></i>Check In Time</span>
                        <span class="font-weight-bold text-darkest-grey" id="modal-clockin-time"><?php echo e($clockInFormatted); ?></span>
                    </div>
                    <div class="list-group-item d-flex justify-content-between align-items-center f-14 py-3">
                        <span class="text-dark-grey"><i class="fa fa-sign-out-alt text-danger mr-2"></i>Logout Time</span>
                        <span class="font-weight-bold text-darkest-grey" id="modal-clockout-time"><?php echo e(now($tz)->format('h:i A')); ?></span>
                    </div>
                    <div class="list-group-item d-flex justify-content-between align-items-center f-14 py-3">
...
<script>
    window.hrmsWorkSecs = parseInt("<?php echo e($workSeconds); ?>") || 0;
    window.hrmsBreakSecs = parseInt("<?php echo e($totalBreakSeconds); ?>") || 0;
    window.hrmsIsClockedIn = Boolean(<?php echo e($isClockedIn ? 'true' : 'false'); ?>);
    window.hrmsIsOnBreak = Boolean(<?php echo e($isOnBreak ? 'true' : 'false'); ?>);
    ...
    window.hrmsAction = function (actionType) {
        ...
        let routes = {
            'checkin': "<?php echo e(route('attendances.quick_clock_in')); ?>",
            'startbreak': "<?php echo e(route('attendances.start_break')); ?>",
            'endbreak': "<?php echo e(route('attendances.end_break')); ?>",
            'checkout': "<?php echo e(route('attendances.quick_clock_out')); ?>"
        };
...
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/components/hrms-attendance-card.blade.php ENDPATH**/ ?>
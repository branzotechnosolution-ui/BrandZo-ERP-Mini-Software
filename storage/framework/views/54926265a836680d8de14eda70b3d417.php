                                        ...
                                        <?php if(!is_null($weekShifts[$key]->requestChange) && $weekShifts[$key]->requestChange->status == 'waiting'): ?>
                                            <div class="task_view">
                                                <a href="javascript:;"
                                                   ...
                                                   data-shift-schedule-date="<?php echo e($weekDate->translatedFormat('Y-m-d')); ?>"
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/dashboard/employee/widgets/shift_schedule.blade.php ENDPATH**/ ?>
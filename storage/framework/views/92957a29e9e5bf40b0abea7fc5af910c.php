        ...
        OneSignal.push(function () {
            ...
            OneSignal.init({
                ...
                notifyButton: {
                    ...
                    theme: "inverse",
                    size: "small",
                    position: '<?php echo e(isRtl() ? 'bottom-left' : 'bottom-right'); ?>',
                    text: {
...
<?php if($pushSetting->beams_push_status == 'active'): ?>
    ...
    <script>
        ...
        const currentUserId = "wrkst-<?php echo e(user()->id); ?>"; // Get this from your auth system

        const beamsClient = new PusherPushNotifications.Client({
            instanceId: "<?php echo e(push_setting()->instance_id); ?>",
        });

        const beamsTokenProvider = new PusherPushNotifications.TokenProvider({
            url: "<?php echo e(route('dashboard.beam_auth')); ?>",
        });
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/sections/push-setting-include.blade.php ENDPATH**/ ?>
<?php if(in_array(\Modules\Webhooks\Entities\WebhooksGlobalSetting::MODULE_NAME, user_modules()) && (user()->permission('view_webhooks') == 'all' || user()->permission('view_webhooks_logs') == 'all')): ?>
...
<?php $component = App\View\Components\MenuItem::resolve(['icon' => 'wallet','text' => 'Webhooks','addon' => App::environment('demo')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\SubMenuItem::resolve(['link' => route('webhooks.index'),'text' => __('webhooks::app.webhooks')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        <?php endif; ?>
        <?php if(user()->permission('view_webhooks_logs') == 'all'): ?>
        <?php if (isset($component)) { $__componentOriginal75a60586017d0cb41cbff8f75f4a3989 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal75a60586017d0cb41cbff8f75f4a3989 = $attributes; } ?>
<?php $component = App\View\Components\SubMenuItem::resolve(['link' => route('webhooks-log.index'),'text' => __('webhooks::app.log')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('sub-menu-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\SubMenuItem::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/Modules/Webhooks/Resources/views/sections/sidebar.blade.php ENDPATH**/ ?>
<?php if(in_array('contract_date', $activeWidgets) && in_array('contracts', user_modules())): ?>
    <?php
...
<?php $component = App\View\Components\Cards\Data::resolve(['title' => __('modules.dashboard.contractDate'),'padding' => 'false'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Employee::resolve(['user' => $contract->user] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                ...
                                <td class="pr-20 text-right">
                                    <?php if($contractDate->setTimezone(company()->timezone)->isToday()): ?>
                                        <span class="badge badge-light text-light p-2"><?php echo app('translator')->get('app.today'); ?></span>
                                    <?php elseif($contractDate->diffInDays($currentDay) <= 7): ?>
                                    ...
                                    <br>
                                    <?php if($contractDate->setTimezone(company()->timezone)->isToday()): ?>
                                        <span class="text-success f-12"><?php echo app('translator')->get('messages.contractMessage'); ?>
                                            <?php echo e($contractDate->translatedFormat($company->date_format)); ?></span>
                                    <?php elseif($contractDate->diffInDays($currentDay) <= 7): ?>
                                        <span class="text-warning f-12"><?php echo app('translator')->get('messages.contractMessage'); ?>
                                            <?php echo e($contractDate->translatedFormat($company->date_format)); ?></span>
                                    <?php else: ?>
                                        <span class="f-12"><?php echo app('translator')->get('messages.contractMessage'); ?>
                                            <?php echo e($contractDate->translatedFormat($company->date_format)); ?></span>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/dashboard/employee/widgets/contract.blade.php ENDPATH**/ ?>
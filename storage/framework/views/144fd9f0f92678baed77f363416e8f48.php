...
<?php endif; ?>
                ...
                <?php if(!in_array('client', user_roles()) && !in_array($viewPermission, ['added', 'owned', 'both'])): ?>
                    <?php if (isset($component)) { $__componentOriginal5e57c6582b8a883148a28bb7ee46d2ad = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad = $attributes; } ?>
...
<?php endif; ?>
                ...
                <?php if($recurringTaskPermission == 'all'): ?>
...
<?php $component = App\View\Components\Forms\LinkSecondary::resolve(['link' => route('recurring-task.index'),'icon' => 'sync'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 float-left']); ?>
                        <?php echo app('translator')->get('app.menu.taskRecurring'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/tasks/index.blade.php ENDPATH**/ ?>
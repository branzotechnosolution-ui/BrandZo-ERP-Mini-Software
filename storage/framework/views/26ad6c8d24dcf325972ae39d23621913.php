...
<?php $component = App\View\Components\SettingMenuItem::resolve(['active' => $activeMenu,'menu' => 'einvoice_settings','href' => route('einvoice.settings'),'text' => __('einvoice::app.menu.einvoiceSettings')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/Modules/EInvoice/Providers/../Resources/views/sections/setting-sidebar.blade.php ENDPATH**/ ?>
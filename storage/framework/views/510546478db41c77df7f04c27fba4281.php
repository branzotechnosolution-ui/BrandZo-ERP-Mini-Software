<?php if($universalBundle): ?>
    <div class='card border mb-4'>
        ...
        <div class="card-body bg-white border-0 pt-4">
            ...
            <?php if($plugins->where('envato_id', config(strtolower($universalBundle) . '.envato_item_id'))->first()): ?>
                <?php
                                ...
                                <div class="alert alert-warning w-100 text-center">
                                    <div class="d-flex flex-column align-items-center">
                                        <h5 class="font-weight-bold mb-2">
                                            ...
                                            Update Available for <?php echo e($universalBundle->getName()); ?>

                                        </h5>
                                        <p>
                                            Current version: <span class="badge badge-danger">v<?php echo e($currentVersion); ?></span>
                                            &nbsp;|&nbsp;
                                            Latest version: <span class="badge badge-success">v<?php echo e($latestVersion); ?></span>
                                        </p>
                                        <p>
                                        ...
                                        <div class="mt-2">
                                            <?php if($plugins->where('envato_id', config(strtolower($universalBundle) . '.envato_item_id'))->pluck('version')->first() > \Illuminate\Support\Facades\File::get($universalBundle->getPath() . '/version.txt')): ?>
                                                <button type="button" class="btn btn-secondary btn-sm update-module"
                                                        data-product-url="<?php echo e(Froiden\Envato\Helpers\FroidenApp::renewSupportUrl(config(strtolower($universalBundle) . '.envato_item_id'))); ?>"
                                                        data-module-name="<?php echo e($universalBundle); ?>">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="d-flex">
                        ...
                        <div class="">
                            <span class="h5 mb-0 mx-2"><?php echo e($universalBundle->getName()); ?></span>
                            <?php if(config(strtolower($universalBundle) . '.setting')): ?>
                                <?php echo $__env->make('custom-modules.sections.version', ['module' => $universalBundle], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endif; ?>
                            <div class="mx-2">
                                <?php if($fetchSetting?->license_type): ?>
                                    <span class="badge badge-secondary"><?php echo e($fetchSetting->license_type); ?></span>
                                    <?php if(str_contains($fetchSetting->license_type, 'Regular')): ?>
                                        <a href="<?php echo e(\Froiden\Envato\Helpers\FroidenApp::buyExtendedUrl(config(strtolower($universalBundle) . '.envato_item_id'))); ?>"
                            ...
                            <?php if($fetchSetting?->purchase_code && $fetchSetting?->supported_until): ?>
                                <div class="mx-2 mt-2">
                                    ...
                                    <?php echo $__env->make('custom-modules.sections.support-date', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="col-md-6 d-flex align-items-center justify-content-end">
                    <div class="">
                        <?php if($fetchSetting): ?>
                            <?php if(config(strtolower($universalBundle) . '.verification_required')): ?>
                                <div class="d-flex align-items-center justify-content-end">
                                     <?php echo $__env->make('custom-modules.sections.purchase-code', ['module' => $universalBundle], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            <?php endif; ?>
                            <?php if($plugins->where('envato_id', config(strtolower($universalBundle) . '.envato_item_id'))->first()): ?>
                                <div class="mt-3 d-flex align-items-center justify-content-end">
                                    <?php echo $__env->make('custom-modules.sections.module-update', ['module' => $universalBundle, 'fetchSetting' => $fetchSetting], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                    <?php if(!config(strtolower($universalBundle) . '.name')): ?>
                        <div class="custom-control custom-switch ml-2" data-toggle="tooltip"
                            data-original-title="<?php echo app('translator')->get('app.moduleSwitchMessage', ['name' => $universalBundle]); ?>">
                            <input type="checkbox" class="custom-control-input change-module-status"
                                id="module-<?php echo e($universalBundle); ?>" data-module-name="<?php echo e($universalBundle); ?>">
                            <label class="custom-control-label cursor-pointer"
                                for="module-<?php echo e($universalBundle); ?>"></label>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <?php if ($__env->exists('universalbundle::install-modules')) echo $__env->make('universalbundle::install-modules', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/custom-modules/sections/universal-bundle.blade.php ENDPATH**/ ?>
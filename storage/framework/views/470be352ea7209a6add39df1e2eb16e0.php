<?php if(!in_array('client', user_roles()) && user()->permission('view_asset') != 'none' && in_array(\Modules\Asset\Entities\AssetSetting::MODULE_NAME, user_modules())): ?>
...
<?php $component = App\View\Components\MenuItem::resolve(['icon' => 'display','text' => __('asset::app.menu.asset'),'link' => route('assets.index'),'addon' => App::environment('demo')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/Modules/Asset/Providers/../Resources/views/sections/sidebar.blade.php ENDPATH**/ ?>
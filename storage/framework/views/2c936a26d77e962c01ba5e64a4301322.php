                ...
                <?php $__currentLoopData = $attendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key2 + 1 <= count($attendance)): ?>
                        ...
                        <td class="px-1">
                            ...
                            data-original-title="<?php echo e(\Illuminate\Support\Str::limit(strip_tags($leaveReasons[$userId][$key2] ?? ''), 50, '...')); ?>">
                            ...
                            <?php elseif($day == 'Holiday'): ?>
                                <a href="javascript:;" data-toggle="tooltip" <?php if(user()->permission('add_attendance') == 'all'): ?> class="edit-attendance" <?php endif; ?>
...
<?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/attendances/ajax/summary_data.blade.php ENDPATH**/ ?>
...
<?php endif; ?>
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            <p class="mb-0 pr-2 f-14 text-dark-grey d-flex align-items-center"><?php echo app('translator')->get('app.category'); ?></p>
            <div class="select-status">
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            <p class="mb-0 pr-2 f-14 text-dark-grey d-flex align-items-center"><?php echo app('translator')->get('modules.productCategory.subCategory'); ?></p>
            <div class="select-status">
    ...
    <script>
        ...
        $('#filter_category_id').change(function(e) {
            ...
            $('#filter_sub_category_id')
                .html('<option value="all"><?php echo app('translator')->get("app.all"); ?></option>')
                .val('all')
        ...
        $('#reset-filters,#reset-filters-2').click(function() {
            ...
            $('#filter_sub_category_id').html('<option value="all"><?php echo app('translator')->get("app.all"); ?></option>');
            $('#filter_sub_category_id').selectpicker("refresh");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbook/Downloads/BrandZo_ERP_Mini_Software 3/resources/views/clients/index.blade.php ENDPATH**/ ?>